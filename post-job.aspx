<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="post-job.aspx.cs" Inherits="ProjectJobPortal.post_job" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="flashPanel" runat="server" Visible="False">
        <div class="flash-message-container">
            <h4 class="flash-message">Job posted Successfully</h4>
        </div>
    </asp:Panel>
    ...
    <div class="post-job-container">
        ...
        <div class="post-job-div">
            <h3>About Job:</h3>
            <asp:TextBox ID="jobAbout" runat="server" TextMode="MultiLine" CssClass="post-job-input post-job-about" OnTextChanged="aboutJob_TextChanged" placeholder="Job requirements and details goes here"></asp:TextBox>
            <asp:Label ID="jobAboutErr" runat="server" Text="Label" ForeColor="Red" Visible="False"></asp:Label>
        </div>

        <div class="post-job-div">
            <asp:Button ID="postJobBtn" runat="server" CssClass="header-getstarted post-job-btn" Text="POST" OnClick="postJobBtn_Click" />
        </div>
    </div>
</asp:Content>
